...
void load_enemies()
{
    squirtle = new Squirtle("squirtlej.png",1000,0,38,36,-5,10,100);
    enemies.push_back(squirtle);
    squirtle = new Squirtle("squirtlej.png",1100,0,38,36,-5,12,100);
    enemies.push_back(squirtle);
    poliwhirl = new Poliwhirl("poliwhirl.png",1200,500,75,80,-7,0,200);
    enemies.push_back(poliwhirl);
    rpidgey = new Rpidgey("Rpidgey.png",0,200,37,30,5,0,50);
...
int main( int argc, char* args[] )
{
	...
	{	
		enemies[i]->handle_events(screen);
	}
